...
namespace Vitrae
{
    ...
    struct aiTypeCvt<aiVector2D>
	{
		...
		static glmType toGlmVal(aiVector2D val) 
		{
    ...
    struct aiTypeCvt<aiVector3D>
	{
		...
		static glmType toGlmVal(aiVector3D val) 
		{
    ...
    struct aiTypeCvt<aiColor3D>
	{
		...
		static glmType toGlmVal(aiColor3D val) 
		{
    ...
    struct aiTypeCvt<aiColor4D>
	{
		...
		static glmType toGlmVal(aiColor4D val) 
		{
			return glm::vec4(val.r, val.g, val.b, val.a);
		}
	};
}