...
namespace Vitrae
{
    ...
    struct GLTypeInfo
	{
		...
		static constexpr StringView GLSLTypeName = "<error type>";
	};
    ...
    template<>
    struct GLTypeInfo<glm::mat3>
	{
		static constexpr StringView GLSLTypeName = "mat3";
	};
    template<>
    struct GLTypeInfo<glm::mat4>
	{
